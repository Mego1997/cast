...
<head>
    @foreach($cast_crew_data as $i)
        <title>{{$i->cast_crew_nameen}} | About us</title>
    @endforeach
    <meta charset="UTF-8">
                            ...
                            <ul >
                                @foreach($nav_main_items as $i)
                                    @if($i->main_item_hassub==1)
                                        <li style="line-height:20px!important;" class="nav-item dropdown">
                                            ...
                                            <ul style="background-color: #101010;margin-top: 10px!important;text-align: center;" class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                                                @foreach($nav_submain_items as $ii)
                                                    @if($i->ID==$ii->main_item_id)
                                                        <li style="padding-top: 8px"><a style="font-size: 15px" class="dropdown-item" href="{{$ii->submain_item_href}}">{{$ii->submain_item_nameEN}}</a></li>
                                                    @endif
                                                @endforeach
                                            </ul>
                                        </li>
                                    @else
                                        ...
                                        <li style="line-height:20px!important;"><a href="../{{$i->main_item_href}}">{{$i->main_item_nameEN}}</a></li>
...
{{--                            <h2 style="text-align: left!important;" class="title uk-heading-hero">The gate of your <br> next project <br>Talented & Crew.</h2>--}}
                                ...
                                <h2 class="title uk-heading-hero text-uppercase" style="text-align: center; color: white">About Us</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="pr__content" id="site-content">
        ...
        <section class="pr__clients pr__section pr__dark uk-section uk-section-large" id="pr__clients" style="background-color: #000;">
            ...
            <div class="section-outer">
                <div class="section-heading pr__center">
                    <div class="uk-container">
                        <div class="inner">
                            <div class="center">
                                <h2 class="title uk-h1">OUR VALUES</h2>
                        ...
                        <div class="listing-items uk-grid uk-grid-match uk-grid-medium uk-child-width-1-3@m" data-uk-grid="">
                            <div class="item about-box">
                                <div class="inner">
                                    ...
                                    <div class="uk-flex uk-flex-left">
                                    <p class="description-about">Attraction ME is a company specialized in creating websites and software systems. We have a trained team that can start from the idea, analyze it, and set a timeline for implementation. We also have a team to supervise the various stages of implementation to reach the product to the best possible quality in terms of design or performance. The expertise of our team always gives us the advantage in terms of selecting, analyzing or implementing new ideas.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item about-box">
                                <div class="inner">
                                    ...
                                    <div class="uk-flex uk-flex-left">
                                        <p class="description-about">The main idea that inspires everyone who works on the site (Cast and Crew) is to create and invent a method that helps the artistic community to solve the problems that hinder its development and progress in Egypt and the Arab world alike, in innovative ways, which affects the development and progress of artistic production in a positive way, and that is why we presented This site.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item about-box">
                                <div class="inner">
                                    ...
                                    <div class="uk-flex uk-flex-left">
                                        <p class="description-about">Work on the site begins with the artist’s registration on the site and the application is examined by a trained team to fulfill what may be missing in the registration process. When the application is completed correctly, the artist’s account is published and thus becomes available to production companies and workers in the artistic field in Egypt and the Arab world</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="section-outer choose-outer">
                <div class="section-heading-choose pr__center">
                    <div class="uk-container">
                        ...
                        <div class="center">
                            <P class="description choose-p" style="font-weight: 400;">Attraction ME is a company specialized in creating websites and software systems.<br/> We have a trained team that can start with an idea, analyze it and set a timeline for its <br/>
                                implementation. We also have a team to supervise the various stages of implementation to reach <br/>the product to the best possible quality in terms of design or performance.<br/> The expertise of our team always gives us the advantage in terms of selecting,
                                analyzing or <br/>implementing new ideas. The aim of our work is to give solutions to <br>facilitate stunt people in all fields.</P>
                        </div>
                    </div><!-- Container End -->
                </div><!-- Heading End -->
            </div> <!-- Outer End -->
