...
<head>
    @foreach($cast_crew_data as $i)
        ...
        <title>{{$i->cast_crew_nameen}} | Locations Registration</title>
    @endforeach
    <!--[if IE]>
        ...
        <section class="ds s-py-70 s-py-lg-100 s-py-xl-150 c-gutter-30">
            <div class="container">
                <div class="row" style="direction: rtl;">
                    <div class="col-12">
                        <h3 class="text-uppercase">تسجيل الموقع</h3>
                        @if (session('status'))
                        ...
                        <form action="{{url('insert-new-location')}}" method = "post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <!-- tabs start -->
                        <ul class="nav nav-tabs" role="tablist" style="padding-right: 0px">
                            <li class="nav-item">
                                <a class="nav-link regtab active" id="tab01" data-toggle="tab" href="#tab01_pane" role="tab" aria-controls="tab01_pane" aria-expanded="true"><span class="d-block mb-1">الخطوة الأولى</span>الاسم</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab02" data-toggle="tab" href="#tab02_pane" role="tab" aria-controls="tab02_pane"><span class="d-block mb-1">الخطوة الثانية</span>العنوان والتواصل</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab04" data-toggle="tab" href="#tab04_pane" role="tab" aria-controls="tab04_pane"><span class="d-block mb-1">الخطوة الثالثة</span>بيانات الموقع</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab05" data-toggle="tab" href="#tab05_pane" role="tab" aria-controls="tab05_pane"><span class="d-block mb-1">الخطوة الرابعة</span>الصورة</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab06" data-toggle="tab" href="#tab06_pane" role="tab" aria-controls="tab06_pane"><span class="d-block mb-1">الخطوة الخامسة</span>التواصل الاجتماعى</a>
                            </li>
                            <li class="nav-item">

                                <a class="nav-link regtab" id="tab07" data-toggle="tab" href="#tab07_pane" role="tab" aria-controls="tab07_pane"><span class="d-block mb-1">الخطوة السادسة</span>انتهى</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="tab01_pane" role="tabpanel" aria-labelledby="tab01">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name " style="padding-left: 15px; padding-right: 0;">اسم المكان [عربى]<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="LocationNameEn" id="LocationNameEn" value="" >
                                        </p>
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">اسم المالك [عربى]<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="OwnerNameEn" id="OwnerNameEn" value="" >
                                        </p>

                                    </div>
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">اسم المكان [انجليزى]<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="LocationNameAr" id="LocationNameAr" value="" >
                                        </p>
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">اسم المالك [انجليزى]<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="OwnerNameAr" id="OwnerNameAr" value="" >
                                        </p>
                                    </div>
                                </div>
                                <p>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">الرقم السرى<span class="required">*</span>
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">اعادة الرقم السرى<span class="required">*</span>
                                            </label>
                            ...
                            <div class="tab-pane fade" id="tab02_pane" role="tabpanel" aria-labelledby="tab02">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">رقم موبايل المالك<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="Phone" id="Phone" value="" >
                                        </p>
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">المحافظة<span class="required">*</span>
                                            </label>
                                            <select name="Governorate"  id="Governorate" class="postform">
                                    ...
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                            ...
                                            <label for="account_last_name" style="padding-left: 15px; padding-right: 0;">البريد الالكترونى<span class="required">*</span>
                                            </label>
                                            <input id="Email" name="Email" type="email" class="form-control mailchimp_email" placeholder="عنوان البريد الالكترونى" >
                                        </p>
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">المدينة<span class="required">*</span>
                                            </label>
                                ...
                                <p >
                                    ...
                                    <textarea rows="2" cols="45" name="FullAddress" class="form-control" placeholder="عنوانك" id="FullAddress"></textarea>
                                </p>
                                <p>
                            ...
                            <div class="tab-pane fade" id="tab04_pane" role="tabpanel" aria-labelledby="tab04">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                            <label for="account_last_name" style="padding-left: 15px; padding-right: 0;">مساحة المكان<span class="required">*</span>
                                            </label>
                                            <input type="number" class="woocommerce-Input woocommerce-Input--text input-text" placeholder="Enter area with &#13217;" name="Area" id="Area" value="">
                                        </p>

                                    </div>
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                            <label for="account_last_name" style="padding-left: 15px; padding-right: 0;">نوع المكان<span class="required">*</span>
                                            </label>
                                            <select name="LocationType"  class="choices form-select" id="LocationType">
                                                <option value="">اختر نوع المكان</option>
                                                @foreach($locations_type as $i)
                                                    <option value="{{$i->type_nameEN}}">{{$i->type_nameEN}}</option>
                                                @endforeach
                                ...
                                <p >
                                    ...
                                    <textarea rows="2" cols="45" name="LocationDesc" class="form-control" placeholder="وصف عن المكان" id="LocationDesc"></textarea>
                                </p>
                            </div>
                            <!-- Image Tab-->
                            <div class="tab-pane fade" id="tab05_pane" role="tabpanel" aria-labelledby="tab05">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                                <div class="card2 text-center ls ms">
                                                    <label for="inputTag3">
                                                        <img id="ProfileImage3" src="{{asset('images/gallery/profile_reg@4x.png')}}" alt="img" width="100%">
                                                        <input style="display: none" id="inputTag3" name="ProfileImage3" type="file" onchange="readURL3(this);" accept="image/png, image/jpeg" />
                                                    </label>                                                    <div class="card-body">
                                                        <h4 class="card-title">
                                                            الصورة الشخصية
                                                        </h4>
                                                ...
                                                <div class="card2 text-center ls ms">
                                                    <label for="inputTag4">
                                                        <img id="ProfileImage4" src="{{asset('images/gallery/profile_reg@4x.png')}}" alt="img" width="100%">
                                                        <input style="display: none" id="inputTag4" name="ProfileImage4" type="file" onchange="readURL4(this);" accept="image/png, image/jpeg" />
                                                    </label>                                                    <div class="card-body">
                                                        <h4 class="card-title">
                                                            الصورة الشخصية
                                                        </h4>
                                ...
                                <p style="direction: ltr;">الصورة الرئيسية بأبعاد [1080 X 1520]<br> الصورة الشخصية بأبعاد [1110 X 1110]</p>
                            </div>
                            <!-- Social Tab-->
                                            ...
                                            <div class="apsc-each-profile">
												...
												<span class="social-icon">
													...
													<span class="media-name">Instagram</span>
                                                        ...
                                                        <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="Socialinstagram" id="account_first_name" value="" >
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="apsc-each-profile">
												...
												<span class="social-icon">
													...
													<span class="media-name">Twitter</span>
                                                        ...
                                                        <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="Socialtwitter" id="account_first_name" value="" >
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="apsc-each-profile">
												...
												<span class="social-icon">
													...
													<span class="media-name">Facebsook</span>
                                                        ...
                                                        <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="Socialfacebook" id="account_first_name" value="" >
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="apsc-each-profile">
												...
												<span class="social-icon">
													...
													<span class="media-name">Youtube</span>
                                                        ...
                                                        <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="Socialyoutube" id="account_first_name" value="" >
                                                    </div>
                                                </a>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="tab07_pane" role="tabpanel" aria-labelledby="tab07">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        @endforeach
                                        <input type="checkbox" id="agreement" name="agreement" value="agreement"><label class="mt-40" for="agreement">أوافق على كل الشروط والقوانين</label>
                                        <p class="col-md-12 ">
                                            <a   style="pointer-events: none;color: white!important; letter-spacing: 0px"  class="button uk-button uk-button-large uk-button-default"
                                                 name="fregister" id="fregister" data-toggle="modal" data-target="#exampleModalCenter">ارسال</a>
                                        </p>
                ...
                <div class="uk-container">
                    <div class="section-inner">
                        <div class="columns uk-grid" data-uk-grid="">
                            ...
                            <div class="pr__cta column">
                                <div class="inner">
                                    <a id="pr__contact" href="#pr__contact__form" class="button uk-button uk-button-large uk-button-default" data-uk-toggle="" style="letter-spacing: 0px">للاستفسار</a>
                                </div>
                            </div>
...
<script>
    ...
    */
    ...
    var LocationNameEn = document.getElementById('LocationNameEn');
    var OwnerNameEn = document.getElementById('OwnerNameEn');
    var LocationNameAr = document.getElementById('LocationNameAr');
    var OwnerNameAr = document.getElementById('OwnerNameAr');
    ...
    checker.onchange = function() {
        if(this.checked && LocationNameEn.value!="" && OwnerNameEn.value!="" && LocationNameAr.value!="" && OwnerNameAr.value!="" && LocationDesc.value!="" && Area.value!="" && Password.value!="" && Phone.value!="" && Email.value!="" && FullAddress.value!="" && inputTag.value!="" && inputTag1.value!="" && inputTag2.value!="" && inputTag3.value!="" && inputTag4.value!=""  && Videolink.value!=""){
            ...
            sendbtn.disabled = true;
            if(LocationNameEn.value!="" && OwnerNameEn.value!="" && LocationNameAr.value!="" && OwnerNameAr.value!="" && LocationDesc.value!="" && Area.value!="" && Password.value!="" && Phone.value!="" && Email.value!="" && FullAddress.value!="" && inputTag.value!="" && inputTag1.value!="" && inputTag2.value!="" && inputTag3.value!="" && inputTag4.value!=""  && Videolink.value!=""){
            ...
            $.ajax({
                ...
                success: function(result){
                    ...
                    $.each(result.AllCities,function(key,value){
                        $("#City").append('<option value="'+value.id+'">'+value.city_name_en+'</option>');
                    });
                }
            });
        });
