    ...
    <div id="box_wrapper">
        <section class="ds s-py-70 s-py-lg-100 s-py-xl-150 c-gutter-30">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="text-uppercase">Talent Registration</h3>
                        @if (session('status'))
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link regtab active" id="tab01" data-toggle="tab" href="#tab01_pane"
                                       role="tab" aria-controls="tab01_pane" aria-expanded="true"><span class="d-block mb-1">Step 1</span>Name</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link regtab" id="tab02" data-toggle="tab" href="#tab02_pane"
                                       role="tab" aria-controls="tab02_pane"><span class="d-block mb-1">Step 2</span>Address and contact</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link regtab" id="tab03" data-toggle="tab" href="#tab03_pane"
                                       role="tab" aria-controls="tab03_pane"><span class="d-block mb-1">Step 3</span>Birth information</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link regtab" id="tab04" data-toggle="tab" href="#tab04_pane"
                                       role="tab" aria-controls="tab04_pane"><span class="d-block mb-1">Step 4</span>Talanted Information</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link regtab" id="tab05" data-toggle="tab" href="#tab05_pane"
                                       role="tab" aria-controls="tab05_pane"><span class="d-block mb-1">Step 5</span>Image</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link regtab" id="tab06" data-toggle="tab" href="#tab06_pane"
                                       role="tab" aria-controls="tab06_pane"><span class="d-block mb-1">Step 6</span>Social</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link regtab" id="tab07" data-toggle="tab" href="#tab07_pane"
                                       role="tab" aria-controls="tab07_pane"><span class="d-block mb-1">Step 7</span>Finish</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="tab01_pane" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name1">First name [English]<span
                                                        class="required">*</span>
                                                </label>
                                                <input type="text"
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name2">Middle name [English]<span
                                                        class="required">*</span>
                                                </label>
                                                <input type="text"
                                                       class="woocommerce-Input woocommerce-Input--text input-textr"
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name3">Last name [English]<span
                                                        class="required">*</span>
                                                </label>
                                                <input type="text"
                                                       class="woocommerce-Input woocommerce-Input--text input-textr"
                                        ...
                                        <div class="col-md-6">
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name4">First name [Arabic]<span
                                                        class="required">*</span>
                                                </label>
                                                <input type="text"
                                                       class="woocommerce-Input woocommerce-Input--text input-textr"
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name5">Middle name [Arabic]<span
                                                        class="required">*</span>
                                                </label>
                                                <input type="text"
                                                       class="woocommerce-Input woocommerce-Input--text input-textr"
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name6">Last name [Arabic]<span
                                                        class="required">*</span>
                                                </label>
                                                <input type="text"
                                                       class="woocommerce-Input woocommerce-Input--text input-textr"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name7">Password<span class="required">*</span>
                                                </label>
                                                <input type="password"
                                                       class="woocommerce-Input woocommerce-Input--text input-textr"
                                        ...
                                        <div class="col-md-6">
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name8">Re-Password<span
                                                        class="required">*</span>
                                                </label>
                                                <input type="password"
                                                       class="woocommerce-Input woocommerce-Input--text input-textr"
                                ...
                                <div class="tab-pane fade" id="tab02_pane" role="tabpanel" aria-labelledby="tab02">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name9">Phone<span class="required">*</span>
                                                </label>
                                                <input type="text"
                                                       class="woocommerce-Input woocommerce-Input--text input-textr"
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name10">Governorate<span
                                                        class="required">*</span>
                                                </label>
                                        ...
                                        <div class="col-md-6">
                                            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                                ...
                                                <label for="account_last_name">Email address<span
                                                        class="required">*</span>
                                                </label>
                                                <input id="Email" name="Email" type="email"
                                                       class="form-control mailchimp_email" placeholder="Email address" value="{{ old('Email') }}">
                                            </p>
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name11">City<span class="required">*</span>
                                                </label>
                                    ...
                                    <p>
                                        ...
                                        <textarea rows="2" cols="45" name="FullAddress" class="form-control"
                                                  placeholder="Your Address" id="FullAddress"></textarea>
                                    </p>
                                    <p>
                                ...
                                <div class="tab-pane fade" id="tab03_pane" role="tabpanel" aria-labelledby="tab03">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name12">Birthdate<span class="required">*</span>
                                                </label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                                <label for="account_first_name13">Gender<span class="required">*</span>
                                                </label>
                                    ...
                                    <p>
                                        ...
                                        <textarea rows="2" cols="45" name="ModelDesc" class="form-control"
                                                  placeholder="Description about yourself" id="ModelDesc" ></textarea>
                                    </p>
                                </div>
                                <!-- Talanted Tab-->
                                <div class="tab-pane fade" id="tab04_pane" role="tabpanel" aria-labelledby="tab04">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                                <label for="account_last_name">Language<span class="required">*</span>
                                                </label>
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                                <label for="account_last_name">Appearance<span class="required">*</span>
                                                </label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                                <label for="account_last_name">Hair Quality<span
                                                        class="required">*</span>
                                                </label>
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                                <label for="account_last_name">Experiences<span
                                                        class="required">*</span>
                                                </label>
                                                <select name="Experiences" class="choices form-select" id="Experiences">
                                                    <option value="">Select</option>
                                                    @foreach($AllExperiences as $i)
                                                        <option value="{{$i->ID}}">{{$i->experiences_nameEN}}</option>
                                                    @endforeach
                                                </select>
                                            </p>
                                            <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                                <label for="account_last_name">Unique<span
                                                        class="required">*</span>
                                                </label>
                                            ...
                                            <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                                <label for="account_last_name">Accent<span
                                                        class="required">*</span>
                                                </label>
                                ...
                                <div class="tab-pane fade" id="tab05_pane" role="tabpanel" aria-labelledby="tab05">
                                    ...
                                    <p>Main Photo with Dimensions [1080 X 1520]<br> Profile Photo with Dimensions [1110
                                        X 1110]</p>
                                </div>
                                <!-- Social Tab-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="checkbox" id="agreement" name="agreement"
                                                   value="agreement"><label class="mt-40" for="agreement">I Agree to
                                                Cast&Crew Terms and Conditions</label>
                                            <p class="col-md-12 ">
                                                <button type="submit"   style="color: white!important;"  class="button uk-button uk-button-large uk-button-default"
                                                       name="fregister" id="fregister" data-toggle="modal" data-target="#exampleModalCenter">Submit</button>
                                            </p>
