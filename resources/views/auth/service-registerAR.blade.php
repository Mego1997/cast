        ...
        <section class="ds s-py-70 s-py-lg-100 s-py-xl-150 c-gutter-30">
            <div class="container">
                <div class="row" style="direction:rtl;">
                    <div class="col-12">
                        <h3 class="text-uppercase">تسجيل الخدمة</h3>
                        @if (session('status'))
                        ...
                        <ul class="nav nav-tabs" role="tablist" style="padding-right: 0;">
                            <li class="nav-item">
                                <a class="nav-link regtab active" id="tab01" data-toggle="tab" href="#tab01_pane" role="tab" aria-controls="tab01_pane" aria-expanded="true"><span class="d-block mb-1">الخطوة الاولى</span>الاسم</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab03" data-toggle="tab" href="#tab03_pane" role="tab" aria-controls="tab03_pane"><span class="d-block mb-1">الخطوة الثالثة</span>بيانات الميلاد</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab04" data-toggle="tab" href="#tab04_pane" role="tab" aria-controls="tab04_pane"><span class="d-block mb-1">الخطوة الرابعة</span>بيانات الخدمة</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab05" data-toggle="tab" href="#tab05_pane" role="tab" aria-controls="tab05_pane"><span class="d-block mb-1">الخطوة الخامسة</span>الصورة</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab06" data-toggle="tab" href="#tab06_pane" role="tab" aria-controls="tab06_pane"><span class="d-block mb-1">الخطوة السادسة</span>التواصل الاجتماعى</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab07" data-toggle="tab" href="#tab07_pane" role="tab" aria-controls="tab07_pane"><span class="d-block mb-1">الخطوة السابعة</span>انتهى</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="tab01_pane" role="tabpanel" aria-labelledby="tab01">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">الاسم الاول [عربى]<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="FirstNameEn" id="FirstNameEn" value="" >
                                        </p>
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">الاسم الثانى [عربى]<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="MiddelNameEn" id="MiddelNameEn" value="" >
                                        </p>

                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">اللقب الاخير [عربى]<span class="required">*</span>
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">الاسم الاول [انجليزى]<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="FirstNameAr" id="FirstNameAr" value="" >
                                        </p>
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">الاسم الثانى [انجليزى]<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="MiddelNameAr" id="MiddelNameAr" value="" >
                                        </p>
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">اللقب الاخير [انجليزى]<span class="required">*</span>
                                            </label>
                                ...
                                <p>
                                    أدخل الاسم بالعربى و الانجليزى.
                                </p>
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                            ...
                            <div class="tab-pane fade" id="tab02_pane" role="tabpanel" aria-labelledby="tab02">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">رقم الموبايل<span class="required">*</span>
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            ...
                                            <select name="City" id="city-dropdown" class="postform" >
                                                <option value="" style="padding-left: 15px; padding-right: 0;">اختر المدينة</option>
                            ...
                            <div class="tab-pane fade" id="tab03_pane" role="tabpanel" aria-labelledby="tab03">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">تاريخ الميلاد<span class="required">*</span>
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">النوع<span class="required">*</span>
                                            </label>
                                ...
                                <p >
                                    ...
                                    <textarea rows="2" cols="45" name="ServDesc" class="form-control" placeholder="وصف عنك" id="ServDesc"></textarea>
                                </p>
                            </div>
                            <!-- Talanted Tab-->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                            <label for="account_last_name" style="padding-left: 15px; padding-right: 0;">سنين الخبرة<span class="required">*</span>
                                            </label>
                                        ...
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row " id="speciali-dropdownMain" style="display: none;">
                                            <label for="account_first_name" style="padding-left: 15px; padding-right: 0;">الخدمة<span class="required">*</span>
                                            </label>
                ...
                <div class="uk-container">
                    <div class="section-inner">
                        <div class="columns uk-grid" data-uk-grid="">
                            ...
                            <div class="pr__cta column">
                                <div class="inner">
                                    <a id="pr__contact" href="#pr__contact__form" class="button uk-button uk-button-large uk-button-default" data-uk-toggle="" style="letter-spacing: 0px !important;">للاستفسار</a>
                                </div>
                            </div>
        ...
        $.ajax({
            ...
            success: function(result){
                $.each(result.Allspeciali,function(key,value){
                    $("#speciali-dropdown").append('<option value="'+value.specialization_nameEN+'">'+value.specialization_nameEN+'</option>');
                });
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                $.each(result.Alljobs,function(key,value){
                    if (value != '' ) {
                        $("#job-dropdown").append('<option value="'+value.job_nameEN+'">'+value.job_nameEN+'</option>');
