    ...
    <div id="box_wrapper">
        <section class="ds s-py-70 s-py-lg-100 s-py-xl-150 c-gutter-30">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="text-uppercase">Location Registration</h3>
                        @if (session('status'))
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab04" data-toggle="tab" href="#tab04_pane" role="tab" aria-controls="tab04_pane"><span class="d-block mb-1">Step 3</span>Location Information</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab05" data-toggle="tab" href="#tab05_pane" role="tab" aria-controls="tab05_pane"><span class="d-block mb-1">Step 4</span>Image</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link regtab" id="tab06" data-toggle="tab" href="#tab06_pane" role="tab" aria-controls="tab06_pane"><span class="d-block mb-1">Step 5</span>Social</a>
                            </li>
                            <li class="nav-item">

                                <a class="nav-link regtab" id="tab07" data-toggle="tab" href="#tab07_pane" role="tab" aria-controls="tab07_pane"><span class="d-block mb-1">Step 6</span>Finish</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name">Location Name[English]<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="LocationNameEn" id="LocationNameEn" value="" >
                                        </p>

                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name">Owner Name[English]<span class="required">*</span>
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name">Location Name[Arabic]<span class="required">*</span>
                                            </label>
                                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-textr" name="LocationNameAr" id="LocationNameAr" value="" >
                                        </p>
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name">Owner Name[Arabic]<span class="required">*</span>
                                            </label>
                            ...
                            <div class="tab-pane fade" id="tab02_pane" role="tabpanel" aria-labelledby="tab02">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--first form-row ">
                                            <label for="account_first_name">Owner Phone<span class="required">*</span>
                                            </label>
                            ...
                            <div class="tab-pane fade" id="tab04_pane" role="tabpanel" aria-labelledby="tab04">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                            <label for="account_last_name">Location Area<span class="required">*</span>
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <p class="woocommerce-form-row woocommerce-form-row--last form-row ">
                                            <label for="account_last_name">Location Type<span class="required">*</span>
                                            </label>
                                ...
                                <p >
                                    ...
                                    <textarea rows="2" cols="45" name="LocationDesc" class="form-control" placeholder="Description about your location" id="LocationDesc"></textarea>
                                </p>
                            </div>
                            <!-- Image Tab-->
                            ...
                            <div class="tab-pane fade" id="tab07_pane" role="tabpanel" aria-labelledby="tab07">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p class="col-md-12 ">
                                            <a   style="pointer-events: none;color: white!important;"  class="button uk-button uk-button-large uk-button-default"
