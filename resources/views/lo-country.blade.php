                    ...
                    <div
                        ...
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/59') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/195') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/178') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/112') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/56') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/21') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/97') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/102') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/116') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/125') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/126') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/159') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/169') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/181') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/205') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/2') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/224') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locations/173') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="container text-left text-md-start mt-5">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                                        ...
                                        <p>
                                            <a style="font-size: 14px" href="#" class="text-reset">What We Offer</a>
                                        </p>
                                        <p>
                                            <a style="font-size: 14px" href="#" class="text-reset">Our Story</a>
                                        </p>
                                        <p>
                                            <a style="font-size: 14px" href="#" class="text-reset">Latest News</a>
                                        </p>
                                        <p>
                                            <a style="font-size: 14px" href="#" class="text-reset">Help Center</a>
                                        </p>
                                    </div>
                                    <!-- Grid column -->
