...
<head>
    @foreach($cast_crew_data as $i)
        ...
        <title>{{$i->cast_crew_nameen}} | Talents</title>
    @endforeach
    <meta charset="utf-8">
    <!--[if IE]>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 animate" data-animation="fadeInDown" data-delay="150">
                        ...
                        <div class="row isotope-wrapper  parent RCF" data-animation="fadeInDown" data-delay="150" id="Checkfilters">
                                        ...
                                        <div class="mutliSelectTA">
                                            <label class="labelTA">
                                                @foreach($AllTalent as $ii)
                                                    <label>
                                                        <input type="checkbox" id="{{$ii->TalentNameEN}}" name="{{$ii->ID}}" value="{{$ii->ID}}"><label class="color-dark-font" for="{{$ii->TalentNameEN}}">{{$ii->TalentNameEN}}</label>
                                                    </label>
                                                @endforeach
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-2 col-sm-6 child EYC" data-animation="fadeInDown" data-delay="150">
                                <dl class="dropdownEC dropdown">
                                    <dtEC>
                                        <a href="#">
                                            <span class="hidaEC">Eye Color</span>
                                        ...
                                        <div class="mutliSelectEC gallery-filters" >
                                            <label class="labelEC">
                                                @foreach($AllEyes as $i)
                                                    <label>
                                                        <input type="checkbox" id="EC{{$i->ColorEN}}" name="{{$i->ID}}" value="{{$i->ID}}"><label class="color-dark-font" for="EC{{$i->ColorEN}}">{{$i->ColorEN}}</label>
                                        ...
                                        <div class="mutliSelectGE">
                                            <label class="labelGE">
                                                @foreach($AllGender as $i)
                                                    <label>
                                                        <input type="checkbox" id="{{$i->GenderEN}}" name="rolesGE[]" value="{{$i->ID}}"><label class="color-dark-font" for="{{$i->GenderEN}}">{{$i->GenderEN}}</label>
                                                    </label>
                                                @endforeach
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-2 col-sm-6 child RHQ" data-animation="fadeInDown" data-delay="150">
                                <dl class="dropdownHQ dropdown">
                                    <dtHQ>
                                        <a href="#">
                                            <span class="hidaHQ">Hair Quality</span>
                                        ...
                                        <div class="mutliSelectHQ">
                                            <label class="labelHQ">
                                                @foreach($AllHairQuality as $i)
                                                    <label>
                                                        <input type="checkbox" id="{{$i->HairQualityEN}}" name="roles[]" value="{{$i->ID}}"><label class="color-dark-font" for="{{$i->HairQualityEN}}">{{$i->HairQualityEN}}</label>
                                                    </label>
                                                @endforeach
                                            </label>
                                        </div>
                                        ...
                                        <div class="mutliSelectHC">
                                            <label class="labelHC">
                                                @foreach($AllHairColor as $i)
                                                    <label>
                                                        <input type="checkbox" id="HC{{$i->HairColorEN}}" name="rolesHC[]" value="{{$i->ID}}"><label class="color-dark-font" for="HC{{$i->HairColorEN}}">{{$i->HairColorEN}}</label>
                                                    </label>
                                                @endforeach
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-2 col-sm-6 child RSC" data-animation="fadeInDown" data-delay="150" >
                                <dl class="dropdownSC dropdown">
                                    <dtSC>
                                        <a href="#">
                                            <span class="hidaSC">Skin Color</span>
                                        ...
                                        <div class="mutliSelectSC">
                                            <label class="labelSC">
                                                @foreach($AllSkinColor as $i)
                                                    <label>
                                                        <input type="checkbox" id="SC{{$i->SkinColorEN}}" name="rolesSC[]" value="{{$i->ID}}"><label class="color-dark-font" for="SC{{$i->SkinColorEN}}">{{$i->SkinColorEN}}</label>
                                                    </label>
                                                @endforeach
                                            </label>
                                        </div>
                                            ...
                                            <label class="labelST">
                                                @if($AllStates!="")
                                                    @foreach($AllStates as $i)
                                                        <label >
                                                            <input type="checkbox" id="{{$i->governorate_name_en}}" name="roles[]" value="{{$i->id}}"><label class="color-dark-font" for="{{$i->governorate_name_en}}">{{$i->governorate_name_en}}</label>
                                                        </label>
                                                    @endforeach
                                                @else
                                                    @foreach($all_states as $i)
                                                        <label >
                                                            <input type="checkbox" id="{{$i->name_en}}" name="roles[]" value="{{$i->id}}"><label class="color-dark-font" for="{{$i->name_en}}">{{$i->name_en}}</label>
                                                        </label>
                                                    @endforeach
                                                @endif
                                            </label>
                        ...
                        <!-- EofSliders Fillters-->
                        <h3 style="font-size: 22px;margin-top: 1px" class="widget-title text-uppercase">Special Search</h3>
                            ...
                            <div class="child EXF" data-animation="fadeInDown" data-delay="150">
                                <div class="widget widget_LState">
                                    <select  name="Experiences" onfocus='handleonfocus(this)' onblur='handleonblur(this)' id="Experiences" class="postform" style="text-align: center!important;">
                                        <option hidden  class="Statedropdown" value="-1" >Experiences</option>
                                        @foreach($AllExperiences as $i)
                                            <option class="Statedropdown" value="{{$i->ID}}" >{{$i->experiences_nameEN}}</option>
                                        @endforeach
                            ...
                            <div class="child LAF" data-animation="fadeInDown" data-delay="150">
                                <div class="widget widget_LState">
                                    <select name="Language" onfocus='handleonfocus(this)' onblur='handleonblur(this)' id="Language" class="postform" style="text-align: center!important;">
                                        <option hidden class="Statedropdown" value="-1">Language</option>
                                        @foreach($AllLanguage as $i)
                                            <option class="Statedropdown" value="{{$i->ID}}" >{{$i->LanguageEN}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="child ACF" data-animation="fadeInDown" data-delay="150">
                                <div class="widget widget_LState">
                                    <select name="Accent" onfocus='handleonfocus(this)' onblur='handleonblur(this)' id="Accent" class="postform" style="text-align: center!important;">
                                        <option hidden class="Statedropdown" value="">Accent</option>
                                        @foreach($AllAccent as $i)
                                            <option class="Statedropdown" value="{{$i->ID}}" >{{$i->accent_nameEN}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="child APF" data-animation="fadeInDown" data-delay="150">
                                <div class="widget widget_LState">
                                    <select name="Appearance" onfocus='handleonfocus(this)' onblur='handleonblur(this)' id="Appearance" class="postform" style="text-align: center!important;">
                                        <option hidden class="Statedropdown" value="">Appearance</option>
                                        @foreach($AllAppearance as $i)
                                            <option class="Statedropdown" value="{{$i->ID}}" >{{$i->appearanceEN}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="child UNF" data-animation="fadeInDown" data-delay="150">
                                <div class="widget widget_LState">
                                    <select name="Unique" onfocus='handleonfocus(this)' onblur='handleonblur(this)' id="Unique" class="postform" style="text-align: center!important;">
                                        <option hidden class="Statedropdown" value="">Unique</option>
                                        @foreach($AllUniquedata as $i)
                                            <option class="Statedropdown" value="{{$i->ID}}" >{{$i->UniqueEN}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function infinteLoadMore(page) {
        $.ajax({
            url: ENDPOINT + "/talents/"+CID+"?page=" + page,
            datatype: "html",
            data: {
                CID:CID
    ...
    function infinteLoadMore2(page2) {
        ...
        $.ajax({
            url: ENDPOINT + "/search?page=" + page2,
            datatype: "html",
            data: {
                search:search,
                Eyecolorf:keysEC,
