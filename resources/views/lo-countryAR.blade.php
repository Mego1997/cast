...
<head>
    @foreach($cast_crew_data as $i)
        <title>{{$i->cast_crew_namear}} | إختيار البلد الخاصة بالمكان </title>
    @endforeach
    <meta charset="UTF-8">
                    ...
                    <div class="items-listing features-boxes uk-grid uk-grid-match uk-grid-medium uk1-child-width-1-3@m d-flex justify-content-center" data-uk-grid="">
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/59') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/195') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/178') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/112') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/56') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/21') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/97') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/102') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/116') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/125') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/126') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/159') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/169') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/181') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/205') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/2') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/224') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../locationsAR/173') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                    </div>
                </div>
