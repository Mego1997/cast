            ...
            <div class="container">
                <div class="row">
                                ...
                                <div class="item-content">
                                    <ul class="model-data">
                                        <li>
                                            ...
                                            <span class="data">{{$data->Services_details->service_nameEN}}</span>
                                        </li>
                                        <li>
                                            <span class="title">Specialization</span>
                                            <span class="data">{{$data->Specializations->specialization_nameEN}}</span>
                                        </li>
                    ...
                    <div class="col-xs-12 col-lg-6">
                        ...
                        <h4 class="pt-10">Contact Our Technical</h4>
                        ...
                        <div class="container text-left text-md-start mt-5">
                            ...
                            <div class="row mt-3" style="margin-left: 0px!important;margin-right: 0px!important;">
                                ...
                                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                                    ...
                                    <p>
                                        <a style="font-size: 14px" href="{{ asset('../talent-country') }}" class="text-reset">About Us</a>
                                    </p>
                                    <p>
                                        <a style="font-size: 14px" href="{{ asset('../services-country') }}" class="text-reset">Blogs</a>
                                    </p>
                                    <p>
                                        <a style="font-size: 14px" href="{{ asset('../locations-country') }}" class="text-reset">Contact Us</a>
                                    </p>
                                </div>
                                <!-- Grid column -->
                                ...
                                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                                    ...
                                    <p>
                                        <a style="font-size: 14px" href="/Castingstars/models" class="text-reset">Talents</a>
                                    </p>
                                    <p>
                                        <a style="font-size: 14px" href="/Castingstars/services" class="text-reset">Technical</a>
                                    </p>
                                    <p>
                                        <a style="font-size: 14px" href="/Castingstars/locations" class="text-reset">Locations</a>
                                    </p>
                                </div>
                                <!-- Grid column -->
