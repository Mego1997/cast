...
<head>
    @foreach($cast_crew_data as $i)
        ...
        <title>{{$i->cast_crew_nameen}} | {{$data->FirstNameEN}} {{$data->LastNameEN}}</title>
    @endforeach
    <meta charset="utf-8">
    <!--[if IE]>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item ">
                            <a style="font-size: 25px!important;" class="nav-link"
                               href="/services-country" id="navbarDropdownMenuLink" role="button"
                        ...
                        <li class="nav-item ">
                            <a style="font-size: 25px!important;" class="nav-link"
                               href="/model-register" id="navbarDropdownMenuLink" role="button"
                               data-bs-toggle="dropdown" aria-expanded="false">
                                Register
                            </a>
                            <ul style="background-color: black!important;text-align: center;"
                        ...
                        <li class="nav-item ">
                            ...
                            <ul style="background-color: black!important;text-align: center;"
                                ...
                                <li style="padding: 8px"><a
                                        style="padding: 0px!important;font-size: 25px;font-weight: 300!important;"
                                        class="dropdown-item"
                                        href="/Castingstars/talent-countryAR">Arabic</a>
                                </li>
                                <li style="padding: 8px"><a
                                        style="padding: 0px!important;font-size: 25px;font-weight: 300!important;"
                                        class="dropdown-item"
                                        href="/Castingstars/talent-country">English</a>
                                </li>
                ...
                <div class="inner">
                    <div class="logo">
                        <a href="/Castingstars">
                            <img style="width: 150%!important;max-width: 150%!important;"
                                 src="../public/images/logo.png" alt="img">
                        </a>
                    </div>
                    ...
                    <div class="navbar pr-font-second">
                        ...
                        <nav class="menu" data-uk-scrollspy-nav="offset: 0; closest: li; scroll: true">
                            <ul>
                                <li style="line-height:20px!important;" class="nav-item"><a href="/main">Home</a></li>
                                <li style="line-height:20px!important;" class="nav-item"><a href="/about-us">About Us</a></li>
                                <li style="line-height:20px!important;" class="nav-item"><a href="/contact-us">Contact</a></li>
                                <li style="line-height:20px!important;" class="nav-item">
                                    ...
                                    <ul style="background-color: #101010;margin-top: 10px!important; text-align: center;"
                                        ...
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="/talent-country">Talents</a></li>
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="/services-country">Technical</a></li>
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="/locations-country">Locations</a></li>
                                    </ul>
                                </li>
                                <li style="line-height:20px!important;" class="nav-item">
                                    <a style="padding: 0px!important; line-height:20px!important;" class="nav-link "
                                    ...
                                    <ul style="background-color: #101010;margin-top: 10px!important; text-align: center;"
                                        class="dropdown-menu dropdown-menu-dark"
                                        aria-labelledby="navbarDarkDropdownMenuLink">
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="/model-register">Talent</a></li>
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="/service-register">Technical</a></li>
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="/locations">Location</a></li>
                                    </ul>
                                </li>
                                <li style="line-height:20px!important;" class="nav-item"><a href="/blogs">Blogs</a></li>
                                <li style="line-height:20px!important;" class="nav-item">
                                    <a style="padding: 0px!important; line-height:20px!important;" class="nav-link "
                                    ...
                                    <ul style="background-color: #101010;margin-top: 10px!important; text-align: center;"
                                        ...
                                        <li style="padding-top: 8px"><a class="dropdown-item"
                                                                        href="../talent-countryAR">Arabic</a></li>
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="../talent-country">English</a>
                                        </li>
        ...
        <section class="ds single-model s-pt-70 s-pb-40 s-pb-sm-70 s-py-lg-100 s-py-xl-150 c-mb-30 c-gutter-50">
            <div class="container">
                <div class="row">
                        ...
                        <div class="vertical-item content-padding item-gallery">
                            <div class="model border-rad-5">
                                    ...
                                    <div class="model-figure">
                                        <div data-thumb="../public/images/gellery_rectengular/{{$data->ProfileImage1}}">
                                            <a href="../public/images/gellery_rectengular/{{$data->ProfileImage1}}">
                                                <img src="../public/images/gellery_rectengular/{{$data->ProfileImage1}}"
                                                     alt="img" data-caption="" data-large_image_width="555"
                                        ...
                                        <div data-thumb="../public/images/gellery_rectengular/{{$data->ProfileImage2}}">
                                            <a href="../public/images/gellery_rectengular/{{$data->ProfileImage2}}">
                                                <img src="../public/images/gellery_rectengular/{{$data->ProfileImage2}}"
                                                     alt="img" data-caption="" data-large_image_width="555"
                                                     data-large_image_height="555">
                                            </a>
                                        </div>
                                        <div data-thumb="../public/images/gellery_rectengular/{{$data->ProfileImage3}}">
                                            <a href="../public/images/gellery_rectengular/{{$data->ProfileImage3}}">
                                                <img src="../public/images/gellery_rectengular/{{$data->ProfileImage3}}"
                                                     alt="img" data-caption="" data-large_image_width="555"
                                                     data-large_image_height="555">
                                            </a>
                                        </div>
                                        <div data-thumb="../public/images/gellery_rectengular/{{$data->ProfileImage4}}">
                                            <a href="../public/images/gellery_rectengular/{{$data->ProfileImage4}}">
                                                <img src="../public/images/gellery_rectengular/{{$data->ProfileImage4}}"
                                                     alt="img" data-caption="" data-large_image_width="555"
                                                     data-large_image_height="555">
                                            </a>
                                        </div>
                                ...
                                <div class="item-content">
                                    <ul class="model-data">
                                        <li>
                                            ...
                                            <span class="data">{{$data->Height}}</span>
                                        </li>
                                        <li>
                                            <span class="title">weight</span>
                                            <span class="data">{{$data->Weight}}</span>
                                        </li>
                                        <li>
                                            <span class="title">age</span>
                                            <span
                                                class="data">{{ \Carbon\Carbon::parse($data->BirthDate)->diff(\Carbon\Carbon::now())->format('%y') }}</span>
                                        </li>
                                        <li>
                                            <span class="title">eyes</span>
                                            <span class="data">{{$data->eyecolor->ColorEN}}</span>
                                        </li>
                                        <li>
                                            <span class="title">hair.Q</span>
                                            <span class="data">{{$data->hairquality->HairQualityEN}}</span>
                                        </li>
                                        <li>
                                            <span class="title">hair.C</span>
                                            <span class="data">{{$data->haircolor->HairColorEN}}</span>
                                        </li>
                                        @if($data->Country == 59)
                                            <li>
                                                <span class="title">State</span>
                                                <span class="data">{{$data->governorates->governorate_name_en}}</span>
                                            </li>
                                        @else
                                            <li>
                                                <span class="title">State</span>
                                                <span class="data">{{$data->all_states->name_en}}</span>
                                            </li>
                                        @endif

                                        <li>
                                            <span class="title">Talent</span>
                                            <span class="data">{{$data->talent->TalentNameEN }}</span>
                                        </li>
                                        <li>
                                            <span class="title">Skin.C</span>
                                            <span class="data">{{$data->skincolor->SkinColorEN }}</span>
                                        </li>
                                        <li>
                                            <span class="title">Gender</span>
                                            <span class="data">{{$data->gender->GenderEN }}</span>
                                        </li>
                                        <li>
                                            <span class="title">Experiences</span>
                                            <span class="data">{{$data->experiences->experiences_nameEN }}</span>
                                        </li>
                                        <li>
                                            <span class="title">Language</span>
                                            <span class="data">{{$data->language->LanguageEN }}</span>
                                        </li>
                                        <li>
                                            <span class="title">Appearance</span>
                                            <span class="data">{{$data->appearance->appearanceEN }}</span>
                                        </li>
                                        <li>
                                            <span class="title">Unique</span>
                                            <span class="data">{{$data->uniquedata->UniqueEN }}</span>
                                        </li>
                                        <li>
                                            <span class="title">Accent</span>
                                            <span class="data">{{$data->accent->accent_nameEN }}</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <p class="social-icons text-center pt-30 mb-0">
                                    <a href="{{$data->Socialfacebook }}" class="fa fa-facebook color-bg-icon rounded"
                                       title="facebook"></a>
                                    <a href="{{$data->Socialinstagram }}" class="fa fa-instagram color-bg-icon rounded"
                                       title="instagram"></a>
                                    <a href="{{$data->Socialtwitter }}" class="fa fa-twitter color-bg-icon rounded"
                                       title="twitter"></a>
                                    <a href="{{$data->Socialyoutube }}" class="fa fa-youtube color-bg-icon rounded"
                                       title="youtube"></a>
                                </p>
                    ...
                    <div class="col-xs-12 col-lg-6">
                        <h2 class="entry-title">{{$data->FirstNameEN}} {{$data->LastNameEN}}</h2>
                        ...
                        <div class="embed-responsive embed-responsive-3by2">
                            <a href="{{$data->Videolink}}" class="embed-placeholder">
                                <img src="../public/images/blog/{{$data->ThubImage}}" alt="img">
                            </a>
                        </div>

                        <h4 class="pt-10">Contact Our {{$data->talentname->TalentNameEN }}</h4>

                        <form action="{{url('query')}}" class="pt-10" method="post">
                            {{csrf_field()}}
                            <div class="form-group">
                                <input title="name" name="OMName" type="hidden" class="form-control"
                                       value="{{$data->FirstNameEN}} {{$data->LastNameEN}}">
                            </div>
                            <div class="form-group">
                                <input title="name" name="OFullName" type="text" class="form-control ptf"
                                       placeholder="full name" required>
                            </div>
                            <div class="form-group">
                                <input title="phone" name="OPhone" type="number" class="form-control ptf"
                                       placeholder="phone number" required>
                            </div>
                            <div class="form-group">
                                <input title="email" name="OEmail" type="email" class="form-control ptf"
                                       placeholder="email address" required>
                            </div>
                            <div class="form-group">
                                <textarea title="message" name="OMassage" cols="30" rows="5" placeholder="your message"
                                          required></textarea>
                                <button type="submit" class="btn-submit"><i class="fa fa-paper-plane"
                        ...
                        <div class="container text-left text-md-start mt-5">
                            ...
                            <div class="row mt-3" style="margin-left: 0px!important;margin-right: 0px!important;">
                                ...
                                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                                    ...
                                    <p>
                                        <a style="font-size: 14px" href="/Castingstars/about-us" class="text-reset">About
                                            Us</a>
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        <a style="font-size: 14px" href="/Castingstars/contact-us" class="text-reset">Contact
                                            Us</a>
                                    </p>
                                </div>
                                <!-- Grid column -->
                    ...
                    <div class="section-inner">
                        <div class="columns uk-grid" data-uk-grid="">
                            ...
                            <div class="pr__copyrights column">
                                <div class="inner">
                                    <p>2022 © <a href="http://attractionme.net/Castingstars/">Cast&Crew</a>, All rights
                                        reserved.</p>
                                </div>
                            </div>
