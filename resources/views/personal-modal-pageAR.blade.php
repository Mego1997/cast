                ...
                <div class="inner">
                    ...
                    <div class="navbar pr-font-second">
                        ...
                        <nav class="menu" data-uk-scrollspy-nav="offset: 0; closest: li; scroll: true">
                            <ul>
                                <li style="line-height:20px!important;" class="nav-item"><a href="/AR">الرئيسية</a></li>
                                <li style="line-height:20px!important;" class="nav-item"><a href="/about-usAR">من نحن</a></li>
                                <li style="line-height:20px!important;" class="nav-item"><a href="/contact-usAR">تواصل معنا</a></li>
                                <li style="line-height:20px!important;" class="nav-item">
                                    ...
                                    <ul style="background-color: #101010;margin-top: 10px!important; text-align: center;"
                                        ...
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="/Castingstars/services">الخدمات التقنية</a></li>
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="/Castingstars/locations">مواقع التصوير</a></li>
                                    </ul>
                                </li>
                                <li style="line-height:20px!important;" class="nav-item">
                                    <a style="padding: 0px!important; line-height:20px!important;" class="nav-link "
                                    ...
                                    <ul style="background-color: #101010;margin-top: 10px!important; text-align: center;"
                                        ...
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="/Castingstars/service-registerAR">المواقع التقنية</a></li>
                                        <li style="padding-top: 8px"><a class="dropdown-item" href="/Castingstars/locationsAR">مواقع التصوير</a></li>
                                    </ul>
                                </li>
            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="model border-rad-5">
                                    ...
                                    <div class="model-figure">
                                        ...
                                        <div data-thumb="../public/images/gellery_rectengular/{{$data->ProfileImage3}}">
                                            <a href="../public/images/gellery_rectengular/{{$data->ProfileImage3}}">
                                                <img src="../public/images/gellery_rectengular/{{$data->ProfileImage3}}" alt="img" data-caption="" data-large_image_width="555" data-large_image_height="555">
                                            </a>
                                        </div>
                                        <div data-thumb="../public/images/gellery_rectengular/{{$data->ProfileImage4}}">
                                            <a href="../public/images/gellery_rectengular/{{$data->ProfileImage4}}">
                                                <img src="../public/images/gellery_rectengular/{{$data->ProfileImage4}}" alt="img" data-caption="" data-large_image_width="555" data-large_image_height="555">
                                            </a>
                                        </div>
                                ...
                                <div class="item-content">
                                    <ul class="model-data">
                                        ...
                                        <li>
                                            ...
                                            <span class="data">{{$data->eyecolor->ColorAR}}</span>
                                        </li>
                                        <li>
                                            <span class="title">الشعر</span>
                                            <span class="data">{{$data->hairquality->HairQualityAR}}</span>
                                        </li>
                                        <li>
                                            <span class="title">لون الشعر</span>
                                            <span class="data">{{$data->haircolor->HairColorAR}}</span>
                                        </li>
                                        @if($data->Country == 59)
                                            <li>
                                                <span class="title">State</span>
                                                <span class="data">{{$data->governorates->governorate_name_ar}}</span>
                                            </li>
                                        @else
                                            <li>
                                                <span class="title">State</span>
                                                <span class="data">{{$data->all_states->name_ar}}</span>
                                            </li>
                                        @endif
                                        <li>
                                            <span class="title">الموهبة</span>
                                            <span class="data">{{$data->talent->TalentNameAR }}</span>
                                        </li>
                                        <li>
                                            <span class="title">البشرة</span>
                                            <span class="data">{{$data->skincolor->SkinColorAR }}</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <span class="title">الخبرة</span>
                                            <span class="data">{{$data->experiences->experiences_nameAR }}</span>
                                        </li>
                                        <li>
                                            <span class="title">اللغة</span>
                                            <span class="data">{{$data->language->LanguageAR }}</span>
                                        </li>
                                        <li>
                                            <span class="title">المظهر</span>
                                            <span class="data">{{$data->appearance->appearanceAR }}</span>
                                        </li>
                                        <li>
                                            <span class="title">السمات</span>
                                            <span class="data">{{$data->uniquedata->UniqueAR }}</span>
                                        </li>
                                        <li>
                                            <span class="title">اللهجة</span>
                                            <span class="data">{{$data->accent->accent_nameAR }}</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="model-slider-thumbs">
                                    <ul class="slides">
                                        ...
                                        <li>
                                            <img src="../public/images/gellery_rectengular/{{$data->ProfileImage3}}" alt="img" width="95" height="95">
                                        </li>
                                        <li>
                                            <img src="../public/images/gellery_rectengular/{{$data->ProfileImage4}}" alt="img" width="95" height="95">
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="col-xs-12 col-lg-6">
                        ...
                        <h4 class="pt-10">تواصل مع {{$data->talentname->TalentNameAR }}</h4>

                        <form action="{{url('query')}}" class="pt-10" method="post">
                            {{csrf_field()}}
                            <div class="form-group">
                                <input title="name" name="OMName" type="hidden" class="form-control" value="{{$data->FirstNameEN}} {{$data->LastNameEN}}" >
                            </div>
                            <div class="form-group">
                                <input title="name" name="OFullName" type="text" class="form-control ptf" placeholder="الاسم بالكامل" required>
                            </div>
                            <div class="form-group">
                                <input title="phone" name="OPhone" type="number" class="form-control ptf" placeholder="رقم التواصل" required>
                            </div>
                            <div class="form-group">
                                <input title="email" name="OEmail" type="email" class="form-control ptf" placeholder="البريد الالكتروني" required>
                            </div>
                            <div class="form-group">
