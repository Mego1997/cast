                    ...
                    <div
                        ...
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/59') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/195') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/116') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/178') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/112') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/56') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/21') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/97') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/102') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/125') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/126') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/159') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/169') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/181') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/205') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/2') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/224') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                        <div class="item feature-box ">
                            <div class="inner inner1">
                                ...
                                <a href="{{ asset('../services/173') }}" class="link uk-position-cover"></a>
                            </div>
                        </div>
                    </div>
                </div>
