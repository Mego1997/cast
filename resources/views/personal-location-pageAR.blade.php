...
<head>
    @foreach($cast_crew_data as $i)
        ...
        <title>{{$i->cast_crew_namear}} | {{$data->location_nameAR}}</title>
    @endforeach
    <meta charset="utf-8">
    <!--[if IE]>
        ...
        <section class="ds single-model s-pt-70 s-pb-40 s-pb-sm-70 s-py-lg-100 s-py-xl-150 c-mb-30 c-gutter-50">
            <div class="container">
                <div class="row">
                                ...
                                <div class="item-content">
                                    <ul class="model-data">
                                        <li>
                                            ...
                                            <span class="data">م² {{$data->area}}</span>
                                        </li>
                                        <li>
                    ...
                    <div class="col-xs-12 col-lg-6">
                        <h2 class="entry-title">{{$data->location_nameAR}}</h2>
                        <h2 class="entry-title">تابع إلي : {{$data->location_o_nameAR}}</h2>
                        <div class="fw-divider-space hidden-below-lg mt--10"></div>
                        <p>
                            {{$data->location_descAR}}
                        </p>
                        ...
                        <h4 class="pt-10">قم بالاستفسار عن المكان</h4>

                        <form action="{{url('query')}}" class="pt-10" method="post">
                            {{csrf_field()}}
                            <div class="form-group">
                                <input title="name" name="OMName" type="hidden" class="form-control" value="{{$data->location_nameAR}}" >
                            </div>
                            <div class="form-group">
                                <input title="name" name="OFullName" type="text" class="form-control" placeholder="الإسم بالكامل" required>
                            </div>
                            <div class="form-group">
                                <input title="phone" name="OPhone" type="tel" class="form-control" placeholder="رقم الهاتف" required>
                            </div>
                            <div class="form-group">
                                <input title="email" name="OEmail" type="email" class="form-control" placeholder="البريد الاللكتروني" required>
                            </div>
                            <div class="form-group">
