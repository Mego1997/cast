                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">Total Talents</h6>
                                                <h6 class="font-extrabold mb-0">{{$modelsCount}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">Total Technicals</h6>
                                                <h6 class="font-extrabold mb-0">{{$servicesCount}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">Total Locations</h6>
                                                <h6 class="font-extrabold mb-0">{{$locationsCount}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h5 class="mb-0 ms-3">Egypt</h5>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <h5 class="mb-0">{{$EgyptCount}}</h5>
                                            </div>
                                            <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h5 class="mb-0 ms-3">Syria</h5>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <h5 class="mb-0">{{$SyriaCount}}</h5>
                                            </div>
                                            <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h5 class="mb-0 ms-3">Lebnanon</h5>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <h5 class="mb-0">{{$LebnanonCount}}</h5>
                                            </div>
                                            <div class="col-12">
                            ...
                            <div class="card-body py-4 px-5">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3 name">
                                        ...
                                        <a class="text-muted mb-0" href="{{ route('logout') }}"
