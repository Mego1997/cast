                ...
                <div class="page-title">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Talents</h3>
                            <p class="text-subtitle text-muted">All Talent Data</p>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Talent Database</li>
                                            ...
                                            @foreach($AllModels as $i)
                                                <tr>
                                                    ...
                                                    <td style="align-items: center">
                                                        <span class="badge bg-warning"><a href="{{ url('edit-model/'.$i->id) }}">Edit</a></span>
                                                        <span class="badge bg-danger"><a onclick="return confirm('Are you sure?')" href="{{"delete-model/".$i->id}}">Delete</a></span>
