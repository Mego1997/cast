...
<body>
    <div id="app">
        ...
        <div id="main">
            ...
            <form action="{{ url('update-location/'.$data->ID) }}" method = "post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Update Location information.</p>
                        </div>
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Location Status</h4>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="LNameEN" type="text" id="helperText" class="form-control" placeholder="Name" value="{{$data->location_nameEN}}" required>
                                        <p><small class="text-muted">Location Name by English Language.</small>
                                        </p>
                                    </div>
                                    <div class="form-group">
                                        <label for="helperText">Location Owner[English]</label>
                                        <input name="LONameEN" type="text" id="helperText" class="form-control" placeholder="Name" value="{{$data->location_o_nameEN}}" required>
                                        <p><small class="text-muted">Location Owner Name by English Language.</small>
                                        </p>
                                    </div>
                                    <div class="form-group">
                                        <label for="helperText">Email</label>
                                        <input name="OEmail" type="email" id="helperText" class="form-control" placeholder="Name" value="{{$data->owner_email}}" required>
                                        <p><small class="text-muted">Owner Email.</small>
                                        </p>
                                    </div>
                                    <div class="form-group">
                                        <label for="helperText">Owner Account Password</label>
                                        <input name="LOPassword" type="password" id="helperText" class="form-control" placeholder="Name" value="{{$data->owner_password}}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="LNameAR" type="text" id="helperText" class="form-control" placeholder="Name" value="{{$data->location_nameAR}}" required>
                                        <p><small class="text-muted">Location Name by Arabic Language.</small>
                                        </p>
                                    </div>
                                    <div class="form-group">
                                        <label for="helperText">Location Owner[Arabic]</label>
                                        <input name="LONameAR" type="text" id="helperText" class="form-control" placeholder="Name" value="{{$data->location_o_nameAR}}" required>
                                        <p><small class="text-muted">Location Owner Name by Arabic Language.</small>
                                        </p>
                                    </div>
                                    <div class="form-group">
                                        <label for="helperText">Owner Phone</label>
                                        <input name="LOPhone" type="number" id="helperText" class="form-control" placeholder="Name" value="{{$data->owner_phone}}" required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="Governorate"  id="state-dropdown" class="choices form-select" required>
                                                    <option value="{{$data->governorates->id}}">{{$data->governorates->governorate_name_en}}</option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="City" id="city-dropdown" class="choices form-select" required>
                                                    <option value="{{$data->city->id}}">{{$data->city->city_name_en}}</option>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <textarea name="LDesc" class="form-control" id="exampleFormControlTextarea1"
                                                      rows="3">{{$data->location_desc}}</textarea>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-10 col-9">
                                                    <input name="LArea" type="number" id="helperText" class="form-control" placeholder="Name" value="{{$data->area}}" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-10 col-9">
                                                    <select name="LType" class="choices form-select" required>
                            ...
                            <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <img id="ProfileImage1" src="../{{ asset("images/gellery_rectengular/$data->location_profileimg1") }}" width="50%">
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">Profile Image</label>
                                                <div class="col-lg-6 col-md-12">
                                                    <img id="ProfileImage2" src="../{{ asset("images/gellery_rectengular/$data->location_profileimg2") }}" width="50%">
                                                </div>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="mb-3">
                                        <label for="formFile" class="form-label">Profile Image</label>
                                        <div class="col-lg-6 col-md-12">
                                            <img id="ProfileImage3" src="../{{ asset("images/gellery_rectengular/$data->location_profileimg3") }}" width="50%">
                                        </div>
                                        <input class="form-control" type="file" id="formFile" name="ProfileImage3" onchange="readURL3(this);" accept="image/png, image/jpeg">
                                        <p><small class="text-muted">Enter Your Main Photo with Dimensions [1110 X 1110].</small>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="mb-3">
                                        <label for="formFile" class="form-label">Profile Image</label>
                                        <div class="col-lg-6 col-md-12">
                                            <img id="ProfileImage4" src="../{{ asset("images/gellery_rectengular/$data->location_profileimg4") }}" width="50%">
                                        </div>
                                        <input class="form-control" type="file" id="formFile" name="ProfileImage4" onchange="readURL4(this);" accept="image/png, image/jpeg">
                                        <p><small class="text-muted">Enter Your Main Photo with Dimensions [1110 X 1110].</small>
                                    </div>
