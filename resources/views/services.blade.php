...
<head>
    @foreach($cast_crew_data as $i)
        ...
        <title>{{$i->cast_crew_nameen}} | Services</title>
    @endforeach
    <meta charset="utf-8">
    <!--[if IE]>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 animate" data-animation="fadeInDown" data-delay="150">
                        ...
                        <!-- Check Box Fillters-->
                        <div class="row isotope-wrapper  parent RKC" data-animation="fadeInDown" data-delay="150" id="Checkfilters">
                            <!-- Experience Fillters-->
                            <div class="col-md-2 col-sm-6 child2" data-animation="fadeInDown" data-delay="150" style="top:-31px!important;">
                                <div class="widgets woocommerce widget_price_filter">

                                    <h3 class="widget-titles text-uppercase">Experience</h3>

                                    <form method="get">
                                        <div class="container">
                                            <div>
                                                <div class="multi-range-sliderXP">
                                                    <input type="range" id="input-leftW" min="1" step="1" max="50" value="1">
                                                    <input type="range" id="input-rightW" min="1" step="1" max="50" value="50">
                            ...
                            <div class="col-md-2 col-sm-6 child3 RS" data-animation="fadeInDown" data-delay="150">
                                <dlS class="dropdownGES dropdown">
                                    <dtGES>
                                        <a href="#">
                                            <span class="hidaGES">Gender</span>
                            ...
                            <div class="col-md-2 col-sm-6 child4 RSE" data-animation="fadeInDown" data-delay="150">
                                <div class="widget widget_LState">
                                    <select name="Governorate" onfocus='handleonfocus(this)' onblur='handleonblur(this)' id="services-dropdown" class="postform" style="text-align: center!important;">
                                        <option hidden class="Statedropdown" value="-1">Services</option>
                                        @foreach($services_details as $i)
                                            <option class="Statedropdown" value="{{$i->ID}}">{{$i->service_nameEN}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-6 child3 RSA" data-animation="fadeInDown" data-delay="150">
                                <div class="widget widget_LState">
                                    <select name="speciali" onfocus='handleonfocus(this)' onblur='handleonblur(this)' id="speciali-dropdown" class="postform" style="text-align: center!important;display: none">
                            ...
                            <div class="col-md-2 col-sm-6 child3 RJB" data-animation="fadeInDown" data-delay="150" >
                                <div class="widget widget_LState">
                                    <select name="job" onfocus='handleonfocus(this)' onblur='handleonblur(this)' id="job-dropdown" class="postform" style="text-align: center!important;display: none">
...
<script type="text/javascript">
    ...
    function infinteLoadMore(page) {
        $.ajax({
            url: ENDPOINT + "/services/"+CID+"?page=" + page,
            datatype: "html",
            data: {
                CID:CID
    ...
    function infinteLoadMore2(page2) {
        ...
        $.ajax({
            url: ENDPOINT + "/search-service?page=" + page2,
            datatype: "html",
            data: {
                search:search,
                keyGE:keyGE,
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                $.each(result.Allspeciali,function(key,value){
                    $("#speciali-dropdown").append('<option class="Statedropdown" value="'+value.ID+'">'+value.specialization_nameEN+'</option>');
                });
            }
        });
        keysSE = [];
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                $.each(result.Alljobs,function(key,value){
                    ...
                    if (value != '' ) {
                        $("#job-dropdown").append('<option class="Statedropdown" value="'+value.ID+'">'+value.job_nameEN+'</option>');
